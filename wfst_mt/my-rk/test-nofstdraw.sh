...
#python align_ibm.py --source $corpuse --target $corpusf --output onetoone.all.txt
python onetoone.py --source $corpuse --target $corpusf --output onetoone.all.txt
python extract_column_symbols.py --column 2 < onetoone.all.txt > onetoone.all.isym
