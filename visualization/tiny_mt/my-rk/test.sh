...
# e.g. (base) ye@ykt-pro:/media/ye/project1/tool/mtandseq2seq-code/21-wfst/my-name-exp$ ./test.sh ./sl.my ./sl.ro ./oneline-tail.ro
...
python ./mk_fst_format.pl --input $input --output $input.formatted
